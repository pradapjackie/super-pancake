...
describe('Security Integration Tests', () => {
  ...
  describe('API Security', () => {
    it('should validate URLs before making requests', async () => {
      expect(() => buildUrlWithParams('not-a-url', {}))
        .toThrow('Invalid url');
    ...
    it('should sanitize auth tokens', async () => {
      expect(() => setAuthToken(123)).toThrow();
      expect(() => setAuthToken({})).toThrow();
  ...
  describe('Content Security', () => {
    it('should sanitize text for safe execution', async () => {
      ...
      // Should be a string and have been processed
  ...
  describe('Error Information Security', () => {
    it('should not leak sensitive information in error messages', async () => {
      ...
      try {
        ...
        // Error should exist and be properly formatted
        expect(error.message).toContain('Failed to query selector');
